    ...
    <div className="row-start-2 row-end-[-2] col-start-1 col-end-[-1] mt-4">
                    ...
                    <thead className="w-full text-white bg-white sticky top-0">
                      <tr className="border-2 border-white bg-[#012150]">
                        ...
                        <th
                          ...
                          colSpan="4"
                        >
                          Current - Non Essential Spendings
                        </th>
                        <th
                          className="min-w-[10vw] px-3 py-3 border-2 border-white text-center text-[1.25rem]"
                          colSpan="4"
                        >
                          Future - Non Essential Spendings
                        </th>
                      </tr>
      ...
      <div className="absolute bottom-0 w-full">
                ...
                <nav className="w-full flex justify-center items-center flex-wrap  bg-[#012150] py-2 px-2">
                    ...
                    <Link to="/ie" className="text-white text-[0.95rem] font-semibold px-3 py-1 bg-[#012150] border-r-2">
                        Income Economic
                    </Link>
                    <Link to="/os" className="text-white text-[0.95rem] font-semibold px-3 py-1 bg-[#012150] border-r-2">
                        Overall Spending
                    </Link>
                    <Link to="/es" className="text-white text-[0.95rem] font-semibold px-3 py-1 bg-[#012150] ">
                        Essential Spending
                    </Link>
                    <Link to="/nes" className="text-white  text-[0.95rem] font-semibold px-3 py-2 border-4 border-white bg-[#c0860c] rounded-full -translate-y-7">
